...
export const elektrickeObvodyBeginner: LessonContent = {
  conceptExplanation: {
...
export const elektrickeObvodyIntermediate: LessonContent = {
  conceptExplanation: {
...
export const elektrickeObvodyAdvanced: LessonContent = {
  conceptExplanation: {
