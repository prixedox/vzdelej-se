...
export const kvantovaFyzikaBeginner: LessonContent = {
  conceptExplanation: {
...
export const kvantovaFyzikaIntermediate: LessonContent = {
  conceptExplanation: {
...
export const kvantovaFyzikaAdvanced: LessonContent = {
  conceptExplanation: {
