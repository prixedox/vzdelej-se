...
export const mechanickeVlneniBeginner: LessonContent = {
  conceptExplanation: {
...
export const mechanickeVlneniIntermediate: LessonContent = {
  conceptExplanation: {
...
export const mechanickeVlneniAdvanced: LessonContent = {
  conceptExplanation: {
