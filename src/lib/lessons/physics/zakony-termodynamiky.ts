...
export const zakonyTermodynamikyBeginner: LessonContent = {
  conceptExplanation: {
...
export const zakonyTermodynamikyIntermediate: LessonContent = {
  conceptExplanation: {
...
export const zakonyTermodynamikyAdvanced: LessonContent = {
  conceptExplanation: {
