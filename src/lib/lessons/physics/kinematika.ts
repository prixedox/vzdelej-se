...
export const kinematikaBeginner: LessonContent = {
  conceptExplanation: {
...
> [!tip] Jednotky: dráha v **metrech** (m), čas v **sekundách** (s), rychlost v **metrech za sekundu** (m/s). Ale v praxi často používáme km a hodiny — pak je rychlost v km/h.`,
        ...
        knowledgeCheck: {
          question: "Auto jede rychlostí $60$ km/h po dobu $30$ minut. Jakou dráhu urazí?",
          choices: [
            { label: "$30$ km", isCorrect: true, feedback: "Správně! $60 \\cdot 0{,}5 = 30$ km." },
            { label: "$60$ km", isCorrect: false, feedback: "Pozor, 30 minut je půl hodiny, ne celá hodina." },
            { label: "$1800$ km", isCorrect: false, feedback: "To by bylo $60 \\cdot 30$ — ale 30 minut $\\neq$ 30 hodin!" },
          ],
          explanation: "Převedeme: $30$ min $= 0{,}5$ h. Pak $s = 60 \\cdot 0{,}5 = 30$ km.",
        },
      },
      {
...
(To je $36$ km/h — opravdu rychlý běžec!)`,
    ...
    },
    {
      ...
      id: "kin-z-5",
      problemStatement: "Dva cyklisté jedou proti sobě. Adam jede $16$ km/h, Bára $8$ km/h. Jsou od sebe $24$ km. Za jak dlouho se potkají?",
      choices: [
        { label: "$1$ hodinu", isCorrect: true },
        { label: "$2$ hodiny", isCorrect: false },
        { label: "$3$ hodiny", isCorrect: false },
        { label: "$0{,}5$ hodiny", isCorrect: false },
      ],
      hints: [
        "Jedou proti sobě, takže se přibližují rychlostí $16 + 8 = 24$ km/h.",
      ],
      solutionExplanation: `Jedou proti sobě — vzdálenost se zmenšuje rychlostí $v_1 + v_2 = 24$ km/h:
$$t = \\frac{24}{24} = 1 \\text{ hodina}$$`,
      difficulty: "hard" as const,
    },
  ],
  explorations: [
    {
      title: "Jak rychlost a čas ovlivňují dráhu?",
      visual: {
        type: "interactive-motion",
        props: {
          maxV: 20,
        ...
        caption: "Nastavte rychlost a čas — sledujte, jak daleko auto dojede",
      },
      tasks: [
        {
          prompt: "Nastavte rychlost na $10$ m/s. Kolik sekund potřebujete, aby auto ujelo $100$ m?",
          observation: "Při $v = 10$ m/s potřebujete $t = 10$ s, protože $s = 10 \\cdot 10 = 100$ m.",
        },
        {
          prompt: "Zdvojnásobte rychlost na $20$ m/s. Kolik sekund teď stačí na $100$ m?",
          observation: "Stačí jen $t = 5$ s. Dvojnásobná rychlost = poloviční čas pro stejnou dráhu.",
        },
      ],
    },
  ],
...
export const kinematikaIntermediate: LessonContent = {
  conceptExplanation: {
...
export const kinematikaAdvanced: LessonContent = {
  conceptExplanation: {
