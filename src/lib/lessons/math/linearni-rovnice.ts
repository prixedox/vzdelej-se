...
export const linearniRovniceBeginner: LessonContent = {
  conceptExplanation: {
...
$$\\begin{array}{ccc} x + 10 & = & 25 \\\\ \\color{#2563eb}{- 10} && \\color{#2563eb}{- 10} \\\\ \\hline x & = & 15 \\end{array}$$`,
        ...
        knowledgeCheck: {
          question: "Máte rovnici $x + 5 = 12$. Jakou operaci provedete na obou stranách, abyste zjistili $x$?",
          choices: [
            { label: "Odečteme $5$", isCorrect: true, feedback: "Ano! Odečtením $5$ izolujeme $x$." },
            { label: "Přičteme $5$", isCorrect: false, feedback: "To by $x$ neizoloval — dostal byste $x + 10 = 17$." },
            { label: "Vydělíme $5$", isCorrect: false, feedback: "Dělením se zbavujeme násobení, ne sčítání." },
          ],
          explanation: "Správně odečteme $5$ od obou stran: $x + 5 - 5 = 12 - 5$, tedy $x = 7$.",
        },
      },
      {
...
$$x = 3 \\times 4 = 12$$`,
        ...
        knowledgeCheck: {
          question: "Rovnice $6x = 42$. Jakou operaci zvolíte?",
          choices: [
            { label: "Vydělíme obě strany $6$", isCorrect: true },
            { label: "Odečteme $6$ od obou stran", isCorrect: false, feedback: "Odčítáním se zbavujeme sčítance, ne koeficientu." },
            { label: "Vynásobíme obě strany $6$", isCorrect: false, feedback: "Tím byste rovnici zkomplikovali: $36x = 252$." },
          ],
          explanation: "Koeficient $6$ odstraníme dělením: $x = 42 \\div 6 = 7$.",
        },
      },
      {
    ...
    steps: [
      {
        ...
        challenge: {
          prompt: "Zapište rovnici pro tuto situaci (např. ve tvaru `ax + b = c`):",
          expectedAnswer: "3x+6=21",
          acceptableAnswers: ["3x + 6 = 21", "3x+6=21", "3*x+6=21", "3·x+6=21"],
        },
      },
      {
        ...
        challenge: {
          prompt: "Co zbyde na pravé straně po odečtení 6?",
          expectedAnswer: "15",
          acceptableAnswers: ["15", "3x=15"],
        },
      },
      {
        ...
        challenge: {
          prompt: "Kolik váží jedna krabička? Vydělte $15 \\div 3$:",
          expectedAnswer: "5",
...
$$x = \\frac{28}{4} = 7$$`,
    ...
    },
    {
      ...
      id: "lr-z-4",
      problemStatement: "Která rovnice odpovídá situaci: *Petr má třikrát víc bonbónů než Jana. Dohromady mají 20 bonbónů.*",
      choices: [
        { label: "$x + 3x = 20$", isCorrect: true },
        { label: "$3x = 20$", isCorrect: false },
        { label: "$x + 3 = 20$", isCorrect: false },
        { label: "$x \\cdot 3 + x = 20x$", isCorrect: false },
      ],
      hints: [
        "Jana má $x$ bonbónů. Petr má třikrát tolik, tedy $3x$.",
      ],
      solutionExplanation: `Jana: $x$, Petr: $3x$. Dohromady: $x + 3x = 4x = 20$, tedy $x = 5$. Jana má 5, Petr 15.`,
      difficulty: "medium" as const,
    },
    {
      type: "multiple-choice" as const,
      id: "lr-z-5",
      problemStatement: "Jaký je první krok při řešení rovnice $5x + 3 = 28$?",
      choices: [
        { label: "Odečteme $3$ od obou stran", isCorrect: true },
        { label: "Vydělíme obě strany $5$", isCorrect: false },
        { label: "Odečteme $5x$ od obou stran", isCorrect: false },
        { label: "Vynásobíme obě strany $3$", isCorrect: false },
      ],
      hints: [
        "Chceme izolovat člen s $x$. Nejdřív se zbavíme konstanty na levé straně.",
      ],
      solutionExplanation: `Nejdřív odstraníme konstantu: $5x + 3 - 3 = 28 - 3$, tedy $5x = 25$. Pak dělíme $5$: $x = 5$.`,
      difficulty: "easy" as const,
    },
  ],
  explorations: [
    {
      title: "Prozkoumejte rovnováhu na váze",
      visual: {
        type: "interactive-balance-scale",
        props: {
          equation: { a: 2, b: 4, right: 10 },
          xRange: [0, 10],
        },
        caption: "Nastavte hodnotu x tak, aby váha byla v rovnováze",
      },
      tasks: [
        {
          prompt: "Nastavte jezdec tak, aby rovnice $2x + 4 = 10$ platila. Jaká je hodnota $x$?",
          observation: "Správná hodnota je $x = 3$, protože $2 \\cdot 3 + 4 = 10$.",
        },
        {
          prompt: "Co se stane, když nastavíte $x$ příliš vysoko? Která strana váhy klesne?",
          observation: "Levá strana bude těžší (má větší hodnotu), takže levá miska klesne dolů.",
        },
      ],
    },
  ],
...
export const linearniRovniceIntermediate: LessonContent = {
  conceptExplanation: {
...
export const linearniRovniceAdvanced: LessonContent = {
  conceptExplanation: {
