...
const TOPIC_ID = "10b3d7ae-1731-4fad-ad0c-11f28e596228";

// ═══════════════════════════════════════════════════════════════
// ZAČÁTEČNÍK — Magnety, pole vodiče, síla na vodič, indukce B
// ═══════════════════════════════════════════════════════════════
const beginner = {
  conceptExplanation: {
...
async function main() {
  ...
  console.log("\n📝 Seeding Brilliant-style lessons for: Magneticke pole\n");
  ...
  console.log("\n🎉 Done! Brilliant-style Magneticke pole lessons seeded.\n");
}
