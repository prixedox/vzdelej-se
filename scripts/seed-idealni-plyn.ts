...
const TOPIC_ID = "4bc4893d-df09-46bb-b753-069b9d5c4ace";

// ═══════════════════════════════════════════════════════════════
// ZAČÁTEČNÍK — Model idealního plynu, stavová rovnice, jednoduché děje
// ═══════════════════════════════════════════════════════════════
const beginner = {
  conceptExplanation: {
...
async function main() {
  ...
  console.log("\n📝 Seeding Brilliant-style lessons for: Idealni plyn\n");
  ...
  console.log("\n🎉 Done! Brilliant-style Idealni plyn lessons seeded.\n");
}
