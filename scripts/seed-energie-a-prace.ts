...
const TOPIC_ID = "5ccdea09-a385-42a8-9a1b-d79aabc30bad";
...
async function main() {
  ...
  console.log("\n📝 Seeding Brilliant-style lessons for: Energie a práce\n");
  ...
  console.log("\n🎉 Done! Brilliant-style Energie a práce lessons seeded.\n");
}
