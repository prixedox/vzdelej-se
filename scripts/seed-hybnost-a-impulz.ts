...
const TOPIC_ID = "3fd37065-8852-4e92-9d87-cff7874ed87d";
...
async function main() {
  ...
  console.log("\n📝 Seeding Brilliant-style lessons for: Hybnost a impulz\n");
  ...
  console.log("\n🎉 Done! Brilliant-style Hybnost a impulz lessons seeded.\n");
}
