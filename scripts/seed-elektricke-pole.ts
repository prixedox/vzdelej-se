...
const TOPIC_ID = "d0fe287b-32be-4c9a-9d17-f1484763c917";

// ═══════════════════════════════════════════════════════════════
// ZAČÁTEČNÍK — Náboj, Coulombův zákon, pole, potenciál
// ═══════════════════════════════════════════════════════════════
const beginner = {
  conceptExplanation: {
...
async function main() {
  ...
  console.log("\n📝 Seeding Brilliant-style lessons for: Elektricke pole\n");
  ...
  console.log("\n🎉 Done! Brilliant-style Elektricke pole lessons seeded.\n");
}
